;;; tangodown-dark-theme.el --- Tango-based custom theme for faces
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(highlight ((,class (:foreground ,alum-1 :background ,alum-5))))
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground ,orange-1))))
   `(font-lock-comment-face ((,class (:foreground ,alum-4))))
   `(font-lock-constant-face ((,class (:foreground ,butter-1))))
   `(font-lock-function-name-face ((,class (:foreground ,choc-2))))
   `(font-lock-keyword-face ((,class (:foreground ,blue-1))))
   `(font-lock-string-face ((,class (:foreground ,cham-2))))
   `(font-lock-type-face ((,class (:foreground ,orange-1))))
   `(font-lock-variable-name-face ((,class (:foreground ,plum-1))))
...
(provide-theme 'tangodown-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; tangodown-dark-theme.el ends here
